...
public class ECAM_Engines extends EICASSubcomponent {
    ...
    protected Path2D buildNeedlePath(int n1_radius) 
    {
       ...
       final Point2D.Double P1 = new Point2D.Double(0,n1_radius_tenth/2);
       final Point2D.Double P2 = new Point2D.Double(n1_radius-n1_radius_tenth,n1_radius_tenth/2);
       
       final Point2D.Double P3 = new Point2D.Double(n1_radius-n1_radius_tenth,n1_radius_tenth);
       
       final Point2D.Double P4 = new Point2D.Double(n1_radius,0);//point
       
       final Point2D.Double P5 = new Point2D.Double(n1_radius-n1_radius_tenth,-n1_radius_tenth);
       
       final Point2D.Double P6 = new Point2D.Double(n1_radius-n1_radius_tenth,-n1_radius_tenth/2);
       final Point2D.Double P7 = new Point2D.Double(0,-n1_radius_tenth/2);
    ...
    private void drawN1(Graphics2D g2, int pos, int num, int line) {
        ...
        if (engine_on) {
        	...
        	g2.setColor(eicas_gc.ecam_normal_color);
          g2.drawLine(eicas_gc.prim_dial_x[pos], n1_y, eicas_gc.prim_dial_x[pos]+n1_r*11/10, n1_y);
        	// 27-Mar-2017 new needle
          //Path2D needle = buildNeedlePath(n1_r);
        	//g2.translate(eicas_gc.prim_dial_x[pos],n1_y);
          //g2.draw(needle);
          //g2.translate(-eicas_gc.prim_dial_x[pos],-n1_y);
          g2.setTransform(original_at);
        }
